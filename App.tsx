...
import UserAccountScreen from './assets/screens/UserAccounScreen';
  ...
  return (
    <NavigationContainer>
       ...
       <Stack.Navigator screenOptions={{headerShown: false}}>
        ...
        <Stack.Screen name="UserAccount" component={UserAccountScreen} options={{animation:'slide_from_right'}}/>
